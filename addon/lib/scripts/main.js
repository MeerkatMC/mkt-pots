...
import { DisplayItem } from "./display_item.js";
...
system.beforeEvents.startup.subscribe((initEvent) => {
    initEvent.blockComponentRegistry.registerCustomComponent("mkt:display_item_bonsai", new DisplayItem(bonsai_pot_items));
    initEvent.blockComponentRegistry.registerCustomComponent("mkt:display_item_flower", new DisplayItem(custom_pot_items));
});
