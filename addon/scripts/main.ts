...
import { DisplayItem, DisplayItems } from "./display_item.js"; 

const displayable_items: DisplayItems = {
  ...
  /* 0:5 retired, free to re-use */
  "minecraft:open_eyeblossom": { catergory: 0, variant: 6, sound: "dig.grass" },
  "minecraft:closed_eyeblossom": { catergory: 0, variant: 7, sound: "dig.grass" }, 
  "minecraft:rose_bush": { catergory: 0, variant: 8, sound: "dig.grass" },
  "minecraft:lilac": { catergory: 0, variant: 9, sound: "dig.grass" },
  "minecraft:peony": { catergory: 0, variant: 10, sound: "dig.grass" },
  "minecraft:sunflower": { catergory: 0, variant: 11, sound: "dig.grass" },
  "minecraft:pitcher_plant": { catergory: 0, variant: 12, sound: "dig.grass" },
  ...
  "minecraft:pale_oak_sapling": { catergory: 2, variant: 14, sound: "dig.grass" },
};

system.beforeEvents.startup.subscribe((initEvent) => {
  initEvent.blockComponentRegistry.registerCustomComponent( "mkt:display_item", new DisplayItem(displayable_items) );
});
