...
export class DisplayItem
{
    ...
    {  
        return this.find_display_item( permutation.getState( 'bap:catergory' ), permutation.getState( 'bap:variant' ) );
    }   /* get_display_item() */
    ...
    update_display_item( event )
    {
        ...
        if ( !mainhand.hasItem() )
        {
            if ( ( current_item != undefined ) && ( current_item != "empty" ) )
            {
                ...
                block.setPermutation( block.permutation.withState( "bap:catergory", 0 ).withState( "bap:variant", 0 ) );
            }
        }
        else
        {
            ...
            block.setPermutation( block.permutation.withState( "bap:catergory", display_item.catergory ).withState( "bap:variant", display_item.variant ) );
